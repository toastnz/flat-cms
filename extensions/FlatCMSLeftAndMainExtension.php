...
class FlatCMSLeftAndMainExtension extends LeftAndMainExtension
{
    ...
    public function init()
    {
        ...
        Requirements::customCSS(
            '.cms .field .chzn-container-single .chzn-single.chzn-container-active, .cms .field input.text:focus, .cms .field textarea:focus, .cms .field .TreeDropdownField:focus' .
        ...
        /* Form Elements */
        Requirements::customCSS(
            '.cms .field .chzn-container-single .chzn-single.chzn-container-active,' .
            '.cms .field input.text:focus, .cms .field textarea:focus, .cms .field .TreeDropdownField:focus' .
            '{border:1px solid ' . $this->owner->config()->cms_highlight_colour . ';}'
        );
